# you can run it directly on the Google Colab if  the local environment cannot run it
# make sure run !pip install evaluate before you run the following code on the colab
# the mean perplexity is 52.66
from evaluate import load

perplexity = load("perplexity", module_type="metric")
predictions = ["孺悲欲见孔子，孔子辞以疾。将命者出户，取瑟而歌，使之闻之。",
